...
const CategoryBadge = ({category}:CategoryBadgeProps) =>{
    const {borderColor,textColor,backgroundColor,chipBackgroundColor} = transactionCategoryStyles[category as keyof typeof transactionCategoryStyles] || transactionCategoryStyles.default
    return (
        ...
        {transactions.map((t:Transaction) =>{
            ...
            return (
              ...
              >
                ...
                <TableCell className="pr-10 pl-2 capitalize min-w-24">
                  {t.paymentChannel}
                </TableCell>
